<div class="col-md-4">
    <div id="sidebar">
      <div class="container-fluid">
        ...
        <div class="category">
          <ul>
            <li class="side-title-head now-with-more-padding"> Blog Categories </li>
        ...
        <div class="popular-post">
          <ul>
            <li class="side-title-head now-with-more-padding"> Popular Article</li>
            @foreach ($popularPosts as $post)
            <li>
              @if ($post->image_thumb_url)
              <div>
                  <a href="{{ route('blog.show', $post->slug) }}">
                    <img class="text-center" src="{{ $post->image_thumb_url }}">
                  </a>
              </div>
              @endif
              <div >
        ...
        <div class="popular-post">
          <ul>
            <li class="side-title-head now-with-more-padding"> TAGS</li>
            <li>
              <ul class="tags">
                @foreach($tags as $tag)
                  <li style="display: inline-block;"><a href="{{ route('tag', $tag->slug) }}">{{ $tag->name }}</a></li>
                @endforeach
              </ul>
            </li>
          </ul>
        ...
        <div class="archives">
          <ul>
            <li class="side-title-head now-with-more-padding"> Blog Archives </li>
